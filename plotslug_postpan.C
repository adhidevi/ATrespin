...
void plotslug_postpan(int slug, int ihwp, int wein, int arm){
	...
	TFile f(Form("./rootfiles/postpan/slugs/slugAvg/slug%d.root",slug),"recreate");
...
//	TCut user_cut = "";
	...
	c2->SaveAs(Form("./plots/postpan/device_%d_rms.pdf",iDL));
